...
const menuItems = [
    // ================= BREAKFAST =================
    {
        ...
        description: "Soft fluffy bhature served with spicy, slow-cooked pindi chole and traditional accompaniments.",
        category: "Breakfast",
        price: 85,
        variants: [
            { label: "1 Pc", price: 85 },
            { label: "2 Pc", price: 140 },
        ],
    ...
    },
    {
        ...
        price: 110,
        variants: [
            { label: "1 Pc", price: 110 },
            { label: "2 Pc", price: 180 },
        ],
    ...
    // ================= CHUR CHUR KULCHE =================
    {
        ...
        description: "Crispy layered kulche stuffed with spiced aloo, served with chole & raita.",
        category: "Chur Chur Kulche",
        price: 150,
        variants: [
            { label: "1 Pc", price: 150 },
            { label: "2 Pc", price: 260 },
        ],
    ...
    },
    {
        ...
        description: "Crunchy kulche filled with aloo and onion stuffing, served with chole & raita.",
        category: "Chur Chur Kulche",
        price: 150,
        variants: [
            { label: "1 Pc", price: 150 },
    ...
    },
    {
        ...
        description: "Flaky chur chur kulche generously stuffed with seasoned paneer, served with chole & raita.",
        category: "Chur Chur Kulche",
        price: 150,
        variants: [
            { label: "1 Pc", price: 150 },
    ...
    },
    {
        ...
        description: "Paneer and onion stuffed kulche with a crispy layered texture, served with chole & raita.",
        category: "Chur Chur Kulche",
        price: 150,
        variants: [
            { label: "1 Pc", price: 150 },
    ...
    },
    {
        ...
        description: "Crispy kulche stuffed with spiced gobhi filling, served with chole & raita.",
        category: "Chur Chur Kulche",
        price: 150,
        variants: [
            { label: "1 Pc", price: 150 },
    ...
    },
    {
        ...
        description: "Gobhi and onion filled chur chur kulche with authentic Punjabi flavors, served with chole & raita.",
        category: "Chur Chur Kulche",
        price: 150,
        variants: [
            { label: "1 Pc", price: 150 },
    ...
    // ================= CHUR CHUR NAAN =================
    {
        ...
        description: "Crispy layered naan stuffed with spiced aloo. Served with choice of Palak / Shahi Paneer and Dal.",
        category: "Chur Chur Naan",
        price: 170,
        variants: [
            { label: "1 Pc", price: 170 },
            { label: "2 Pc", price: 300 },
        ],
    ...
    },
    {
        ...
        description: "Crunchy chur chur naan with aloo and onion stuffing. Served with choice of Palak / Shahi Paneer and Dal.",
        category: "Chur Chur Naan",
        price: 170,
        variants: [
            { label: "1 Pc", price: 170 },
    ...
    },
    {
        ...
        description: "Paneer-filled chur chur naan with a crispy texture and rich taste. Served with choice of Palak / Shahi Paneer and Dal.",
        category: "Chur Chur Naan",
        price: 170,
        variants: [
            { label: "1 Pc", price: 170 },
    ...
    },
    {
        ...
        description: "Layered naan stuffed with paneer and onions. Served with choice of Palak / Shahi Paneer and Dal.",
        category: "Chur Chur Naan",
        price: 170,
        variants: [
            { label: "1 Pc", price: 170 },
    ...
    },
    {
        ...
        description: "Chur chur naan stuffed with a mix of vegetables and paneer. Served with choice of Palak / Shahi Paneer and Dal.",
        category: "Chur Chur Naan",
        price: 170,
        variants: [
            { label: "1 Pc", price: 170 },
    ...
    },
    {
        ...
        description: "Crispy naan filled with spiced gobhi stuffing. Served with choice of Palak / Shahi Paneer and Dal.",
        category: "Chur Chur Naan",
        price: 170,
        variants: [
            { label: "1 Pc", price: 170 },
    ...
    // ================= THALI =================
    {
        ...
        description: "2 Tawa Roti, 1 Besan Roti, Baigan Bharta, Dal, Raita, Rice, Paneer.",
        category: "Thali",
        price: 260,
    ...
    // ================= PARTY PACKING =================
    {
        id: "31",
        name: "Chola",
        description: "Slow-cooked chickpea curry with rich spices, packed for parties and gatherings.",
        category: "Party Packing",
        price: 100,
        variants: [
            { label: "250 gm", price: 100 },
            { label: "500 gm", price: 190 },
    ...
    },
    {
        ...
        price: 170,
        variants: [
            { label: "250 gm", price: 170 },
            { label: "500 gm", price: 330 },
            { label: "1 kg", price: 610 },
        ],
    ...
    },
    {
        ...
        variants: [
            { label: "250 gm", price: 170 },
            { label: "500 gm", price: 310 },
            { label: "1 kg", price: 570 },
        ],
